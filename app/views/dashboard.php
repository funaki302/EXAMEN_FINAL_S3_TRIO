        ...
        <div class="col-lg-6 col-12 mt-4 mt-lg-0">
          <div class="card shadow h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Répartition des dons</h6>
            </div>
            <div class="card-body pb-0 p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-0">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <span class="me-2 text-sm font-weight-bold text-dark">Distribués</span>
                      <span class="ms-auto text-sm font-weight-bold" id="dash-pct-distribue">0%</span>
                    </div>
                    <div>
                      <div class="progress progress-md">
                        <div class="progress-bar bg-gradient-success" id="dash-bar-distribue" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <span class="me-2 text-sm font-weight-bold text-dark">En attente</span>
                      <span class="ms-auto text-sm font-weight-bold" id="dash-pct-attente">0%</span>
                    </div>
                    <div>
                      <div class="progress progress-md">
                        <div class="progress-bar bg-gradient-info" id="dash-bar-attente" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <span class="me-2 text-sm font-weight-bold text-dark">Restant</span>
                      <span class="ms-auto text-sm font-weight-bold" id="dash-pct-restant">0%</span>
                    </div>
                    <div>
                      <div class="progress progress-md">
                        <div class="progress-bar bg-gradient-warning" id="dash-bar-restant" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                      </div>
                    </div>
                  </div>
                </li>
            ...
            <div class="card-footer pt-0 p-3 d-flex align-items-center">
              ...
              <div class="w-40 text-end">
                <button class="btn btn-dark mb-0 text-end" type="button" id="btn-dash-refresh-dons">Actualiser</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 mb-md-0 mb-4">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div id="objectifs-dashboard" style="max-height: 500px; overflow-y: auto;">
                <div class="p-3 text-sm text-secondary">Chargement...</div>
              </div>
            </div>
          </div>
        </div>
